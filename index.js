...
app.post("/submit", (req, res) => {
  ...
  var adjRandomNuber= (Math.floor(Math.random()*adjSize)); // generat no. between 0 and adjsize-1 (both inclusive)
  var nounRandomNuber= (Math.floor(Math.random()*nounSize)); // generat no. between 0 and Nounsize-1 (both inclusive)

  const name = adj[adjRandomNuber]+" "+ noun[nounRandomNuber];
